...
export const TAGLINES = {
  primary: "A truly Sicilian treat. For the unexpected.",
  secondary: "A little peculiar, always delicious.",
  italian_tradition: "Italian Tradition. Crafted in California.",
  logistics: "We handle the logistics. You make the impression.",
};

// Five client-approved pillars from the corporate deck (slide 03)
...
// Corporate deck use cases (slide 05) — 6 real ones
export const CORPORATE_USE_CASES = [
  { title: "Client Appreciation", body: "Show key clients they're valued — beyond the holidays." },
  { title: "Employee Recognition", body: "Mark milestones, onboarding, and team achievements." },
...
// Fulfillment options (slide 09) — 4 real
export const FULFILLMENT = [
  { title: "Single Address Delivery", body: "Bulk delivery to one address — most cost-efficient per unit. Ideal for internal team distribution." },
  { title: "Multi-Recipient Delivery", body: "We ship direct to every recipient on your list. Perfect for remote teams or client appreciation." },
  { title: "Local Pickup", body: "Available for Bay Area clients. No shipping cost — coordinate directly with our team." },
  { title: "Rush Orders", body: "Expedited production and delivery available upon request. Surcharge applies." },
];

// Process steps (slide 10) — 4 real
export const PROCESS = [
  { n: "01", title: "Define Your Needs", body: "We align on your timeline, recipients, and gifting objectives." },
  { n: "02", title: "Select Your Gift Program", body: "Choose the format and volume that best fits your needs." },
  { n: "03", title: "We Execute", body: "From production to packaging to delivery, we manage the entire process." },
  { n: "04", title: "A Lasting Impression", body: "Your recipients receive a thoughtful, elevated gift that reflects your brand." },
];

// Existing testimonials & journal — kept as-is
export const TESTIMONIALS = [
  ...
  {
    quote:
      "The wrap, the paper, the look of it when open. The smell, like a cookie my mom used to make. The way it slices. The taste is SO good — I could NOT stop eating it.",
    name: "Lucinda Buxton Marin",
    role: "Pastry Chef",
  },
  {
    quote:
      "The most amazing, decadent, delicious chocolate salami I have ever tasted. Of course it helps that Eva is from Sicily and uses the finest chocolate. The highest rating of all.",
    name: "Maria C. Spurlock",
    role: "San Francisco",
  },
  {
    quote:
      "A revelation — rich, indulgent, and absolutely delicious. It's become a fast favorite in our home, perfect for sharing or enjoying solo. A standout treat.",
    name: "Melanie L.",
    role: "Local press",
  },
];
...
export const PRESS = [
  "Selected by SF Made — Here & Now 2024",
  "Italian Tradition · Crafted in California",
  "Featured on local pastry chef tables",
