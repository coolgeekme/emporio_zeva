...
SEED_PRODUCTS = [
    ...
    # Retained for any old links — repositioned as a future bundle, not an active SKU
    {
        ...
        "long_description": "Designed as a host gift or a quiet indulgence. Currently in development with a small San Francisco workshop. Join the waitlist to be first in line for a board from the first run.",
        "ingredients": [
    ...
    "home": {
        ...
        "sections": [
            ...
            {"label": "Future offerings", "fields": [
                ...
                {"key": "future_title_line2", "type": "text", "label": "H2 line 2 (italic)", "default": "Join the list today."},
                {"key": "future_body", "type": "textarea", "label": "Body",
                 "default": "New formats and flavors arrive only when Eva is happy with them. Join the list and we'll write when each one comes out of the kitchen."},
            ]},
        ...
        "sections": [
            {"label": "Header", "fields": [
                ...
                {"key": "header_body", "type": "textarea", "label": "Body",
                 "default": "We make one thing for now — and we make it well. Below: the signature Not A Salami. Further down: what's next from Eva's kitchen — join the list to be first."},
            ]},
            {"label": "Future offerings", "fields": [
                {"key": "future_overline", "type": "text", "label": "Overline",
                 "default": "From Eva's kitchen · future offerings"},
